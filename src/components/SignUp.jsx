  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md relative">
        ...
        <div className="p-8">
          <h2 className="text-2xl font-semibold text-[#2A1B1B] mb-2">Create an account</h2>
          <p className="text-[#2A1B1B]/70 mb-6 text-sm">
            Sign up to save and access your questionnaire history
          </p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-[#2A1B1B] mb-2">
                Full Name
              </label>
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-[#2A1B1B] mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
